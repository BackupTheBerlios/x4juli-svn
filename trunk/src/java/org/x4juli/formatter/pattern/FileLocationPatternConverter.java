 ...
 * @since 0.5
 */
public class FileLocationPatternConverter extends LogRecordPatternConverter {
    ...
    public void format(final ExtendedLogRecord record, final StringBuffer toAppendTo) {
        ...
        if (locationInfo != null) {
            toAppendTo.append(locationInfo.getFileName());
        } else {
...
// EOF FileLocationPatternConverter.java
