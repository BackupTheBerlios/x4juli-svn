...
public abstract class NameAbbreviator {
     ...
     * elements in the name, "%logger(1~.2~} will output the first character of
     * the first element, two characters of the second and subsequent elements
     * and will use a tilde to indicate abbreviated characters.
     *
