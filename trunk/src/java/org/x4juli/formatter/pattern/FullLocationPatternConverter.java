...
/**
 * Format the record's full line location information.
 * <p>
 ...
 * @since 0.5
 */
public class FullLocationPatternConverter extends LogRecordPatternConverter {
     ...
     * @since 0.5
     */
    public void format(final ExtendedLogRecord record, StringBuffer toAppendTo) {
        LocationInfo locationInfo = record.getLocationInformation();

        if (locationInfo != null) {
            toAppendTo.append(locationInfo.getFullInfo());
        } else {
...
// EOF FullLocationPatternConverter.java
