 ...
 * @since 0.5
 */
public class MessagePatternConverter extends LogRecordPatternConverter {
    ...
    public void format(ExtendedLogRecord record, StringBuffer toAppendTo) {
        toAppendTo.append(FormatterUtil.formatMessage(record));
    }

}

// EOF MessagePatternConverter.java
