...
/**
 * Collects all configuration significant elements from an XML parse.
 * <p>
 ...
 * published by <i>Curt Arnold</i>. Please use exclusively the <i>appropriate</i> mailing lists
 * for questions, remarks and contribution.
 * </p>
 * 
 * @author Boris Unckel
 * @since 0.7
...
public final class JoranDocument extends DefaultHandler {
    ...
    public static final String X4JULI_NS = "http://org.x4juli/";

    public static final String LS_NS = "http://org.x4juli/";
    ...
    public void startElement(final String namespaceURI, final String localName, final String qName,
        ...
        if ((namespaceURI == null) || (namespaceURI.length() == 0)
                || namespaceURI.equals(X4JULI_NS) || namespaceURI.equals(LS_NS)) {
    ...
    public InputSource resolveEntity(final String publicId, final String systemId)
        ...
        if ((systemId != null) && systemId.endsWith("log4j.dtd")) {
            getLogger().warning("The 'log4j.dtd' is no longer used nor needed.");
            // getLogger().warning("See {}#log4j_dtd for more details.", Constants.CODES_HREF);
        ...
        try {
            ...
            if (e instanceof SAXException) {
                ...
                getLogger().log(Level.SEVERE, "Default entity resolver threw an IOException", e);
                return null;
            } else {
    ...
    private abstract static class ElementEvent {
        ...
        public void replay(final ContentHandler handler, final LocatorImpl replayLocation)
                throws SAXException {
            if (location != null) {
    ...
    private static class EndElementEvent extends ElementEvent {
        ...
        public void replay(final ContentHandler handler, final LocatorImpl replayLocation)
            ...
            handler.endElement(JoranDocument.X4JULI_NS, getLocalName(), getLocalName());
        }
    }
    ...
    private static class StartElementEvent extends ElementEvent {
        ...
        public StartElementEvent(final String localName, final Locator location,
                final Attributes attributes) {
            super(localName, location);
        ...
        public void replay(final ContentHandler handler, final LocatorImpl replayLocation)
                throws SAXException {
            super.replay(handler, replayLocation);
            handler.startElement(JoranDocument.X4JULI_NS, getLocalName(), getLocalName(),
                    attributes);
        }
    }
