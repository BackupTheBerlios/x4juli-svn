...
public class Pattern {
    ...
    /**
     * Returns the number of "tail" components that this pattern has in common with the pattern p
     * passed as parameter. By "tail" components we mean the components at the end of the pattern.
     */
