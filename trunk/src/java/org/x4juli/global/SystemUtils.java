 ...
 *
 * <p>
 * This file has been taken from <a
 * href="http://jakarta.apache.org/commons/lang" /> All credits for initial
 * idea, design, implementation, documentation belong to the following projects
 * and persons. This file was originally published by <i>Avalon Excalibur,
 * Lucene, Stephen Colebourne, Steve Downey, Gary Gregory, Michael Becke,
 * Tetsuya Kaneuchi, Rafal Krupinski, Jason Gritman</i>. Please use exclusively
...
public class SystemUtils {
     ...
     * @since 2.0
     */
    public static final boolean IS_OS_WINDOWS_95 = getOSMatches(OS_NAME_WINDOWS_PREFIX + " 9",
            "4.0");
     ...
     * @since 2.0
     */
    public static final boolean IS_OS_WINDOWS_98 = getOSMatches(OS_NAME_WINDOWS_PREFIX + " 9",
            "4.1");
    ...
    private static String getSystemProperty(final String property) {
        ...
        try {
            return (String) java.security.AccessController
                    .doPrivileged(new sun.security.action.GetPropertyAction(property));
