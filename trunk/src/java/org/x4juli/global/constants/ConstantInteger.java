...
public class ConstantInteger implements Constant {
     ...
     * @since 0.5
     */
    protected ConstantInteger(final Integer value) {
        if (value == null) {
     ...
     * @since 0.5
     */
    protected ConstantInteger(final int value) {
     ...
     * @since 0.5
     */
    public static final ConstantInteger lookup(final Class dataType, final Integer value) {
        return (ConstantInteger) ((Map) CONSTANTS_MASTER_INDEX.get(dataType)).get(value);
    }
     ...
     * @since 0.5
     */
    public static final ConstantInteger lookup(final Class dataType, final int value) {
        return lookup(dataType, new Integer(value));
    }
     ...
     * @since 0.5
     */
    public final int getValueAsPrimitive() {
     ...
     */
    public final Integer getValueAsObject() {
        return this.value;
    }
