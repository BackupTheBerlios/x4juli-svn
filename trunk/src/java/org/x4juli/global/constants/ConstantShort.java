 ...
 * @since 0.5
 */
public class ConstantShort implements Constant {

    // -------------------------------------------------------------- Variables

    private static final long serialVersionUID = -6217214989746792269L;
     ...
     * @since 0.5
     */
    protected ConstantShort(final Short value) {
        if (value == null) {
     ...
     * @since 0.5
     */
    public static final ConstantShort lookup(final Class dataType, final Short value) {
        return (ConstantShort) ((Map) CONSTANTS_MASTER_INDEX.get(dataType)).get(value);
    }
     ...
     */
    public static final ConstantShort lookup(final Class dataType, final short value) {
        return lookup(dataType, new Short(value));
    }
     ...
     * @since 0.5
     */
    public final short getValueAsPrimitive() {
     ...
     * @since 0.5
     */
    public final Short getValueAsObject() {
        return this.value;
    }
