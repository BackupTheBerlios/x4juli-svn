...
public class ConstantLong implements Constant {
    ...
    private static final long serialVersionUID = -696305137069864722L;
     ...
     * @since 0.5
     */
    protected ConstantLong(final Long value) {
        if (value == null) {
     ...
     * Creates a new instance of ConstantObject.
     *
     * @param key The value for the constant object.
     * @throws IllegalArgumentException If the user passes a null value.
     * @since 0.5
     */
    protected ConstantLong(final long key) {
        this(new Long(key));
    }
     ...
     * @param key The value of the constant.
     * @return The constant object for the given class and value.
     * @since 0.5
     */
    public static final ConstantLong lookup(final Class dataType, final Long key) {
        return (ConstantLong) ((Map) CONSTANTS_MASTER_INDEX.get(dataType)).get(key);
    }
     ...
     * @since 0.5
     */
    public static final ConstantLong lookup(final Class dataType, final long value) {
        return lookup(dataType, new Long(value));
    }
     ...
     * @since 0.5
     */
    public final Long getValueAsObject() {
        return this.value;
    }
