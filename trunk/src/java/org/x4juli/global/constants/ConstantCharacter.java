 ...
 * @since 0.5
 */
public class ConstantCharacter implements Constant {

    // -------------------------------------------------------------- Variables

    private static final long serialVersionUID = -696105237069864717L;
     ...
     * @since 0.5
     */
    protected ConstantCharacter(final Character value) {
        if (value == null) {
     ...
     * @since 0.5
     */
    protected ConstantCharacter(final char value) {
     ...
     * @since 0.5
     */
    public static final ConstantCharacter lookup(final Class dataType, final Character value) {
        return (ConstantCharacter) ((Map) CONSTANTS_MASTER_INDEX.get(dataType)).get(value);
    }
     ...
     * @since 0.5
     */
    public static final ConstantCharacter lookup(final Class dataType, final char value) {
        return lookup(dataType, new Character(value));
    }
     ...
     * @since 0.5
     */
    public final Character getValueAsObject() {
        return this.value;
    }
