...
public class ConstantDouble implements Constant {
    // -------------------------------------------------------------- Variables
    private static final long serialVersionUID = -696105237064864718L;
     ...
     * @since 0.5
     */
    protected ConstantDouble(final Double value) {
        if (value == null) {
     ...
     * @since 0.5
     */
    public static final ConstantDouble lookup(final Class dataType, final Double value) {
        return (ConstantDouble) ((Map) CONSTANTS_MASTER_INDEX.get(dataType)).get(value);
    }
     ...
     */
    public static final ConstantDouble lookup(final Class dataType, final double value) {
        return lookup(dataType, new Double(value));
    }
     ...
     * @since 0.5
     */
    public final double getValueAsPrimitive() {
     ...
     */
    public final Double getValueAsObject() {
        return this.value;
    }
