...
/**
 * Implement this interface to create new instances of <code>ExtendedLogger</code>.
 * 
 * <p>
...
public interface LoggerFactory {
    ...
    /**
     * @param name of the new logger instance.
     * @param resourcebundleName 
     * @return the new Logger instance.
     */
    ExtendedLogger makeNewLoggerInstance(String name, String resourcebundleName);
    
    /**
     * Full qualified classname of the logger produced by this factory.
     * @return the full qualified classname of the logger.
     */
    String getFQCNofLogger();
}

// EOF LoggerFactory.java
