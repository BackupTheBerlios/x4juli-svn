...
/**
 * Used to store special x4juli errors which cannot be logged using internal
 * logging. Such errors include those occurring during the initial phases
 * of x4juli configuration or errors emanating from core components such as
 * Logger or Hierarchy.
 * <p>
...
public class ErrorItem {
    ...
    /**
     * Dump the details of this ErrorItem to System.err.
     */
    public void dump() {
      dump(System.err);
    }
