...
/**
 * Job is a very simple interface. It only has a single method {@link #execute} which is called by
 * the {@link Scheduler} when a task is ready for execution.
 * 
 * It is assumed that the execution context are contained within the implementing {@ink Job} itself.
 * <p>
