...
set JAVA_OPTS=%JAVA_OPTS% -Djava.util.logging.manager=org.x4juli.X4JuliLogManager -Djava.util.logging.config.file="${catalina.base}\conf\logging.properties"

Result in catalina.sh
JAVA_OPTS="$JAVA_OPTS "-Djava.util.logging.manager=org.x4juli.X4JuliLogManager" "-Djava.util.logging.config.file="$CATALINA_BASE/conf/logging.properties"
...
7) Copy x4juli.war and x4juli-jcl.war in your webapps directory

8) Put the commons-logging.properties (provided in this directory) file in your ${catalina.base}/server/classes
...
10) Call http://localhost:8080/x4juli/JclSample
     ...
     Notice that JCL is working with it's default wrapper class

11) Call http://localhost:8080/x4juli-jcl/JclSample
     Output is directed to ${catalina.base}/logs/x4julidemo.log
     There is also Output send to System.out and System.err.
